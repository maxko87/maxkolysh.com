...
export const rooms = [
  ...
  {id:'rear-bed',name:'Rear left bedroom',level:0,x:6,z:26},
  {id:'side-bed',name:'Rear right bedroom',level:0,x:20,z:27},
  {id:'hallway',name:'Main hallway',level:0,x:13.3,z:30},
  {id:'main-bath',name:'Hall bathroom',level:0,x:8,z:36},
  {id:'office-bath',name:'Office bathroom',level:0,x:4,z:43},
...
export const partitions: WallSpec[][] = [
  [
    ...
    [5.75,33.5,11.5,.32], [20.2,34.8,9.6,.32],
    [11.5,45.9,.32,12.2,48.5,4.2],
    [7.75,39.8,7.5,.32], [4,36.65,.32,6.3],
    [5.75,46.1,11.5,.32,2.5,2.4],
    [8,43,.32,6.2], [9.75,43.1,3.5,.32],
